...
public class PathologyReportMinAuthorPathologistTest extends Base {
    ...
    @Test
    public void test_MIN_PathologyReportCreation() throws ParserConfigurationException, JAXBException, SchemaValidationException, SchematronValidationException, IOException, ParseException,
            URISyntaxException {
        generateMin();
    ...
    public void generateMin() throws IOException, ParserConfigurationException, JAXBException, ParseException, SchematronValidationException {
        ...
        SubjectOfCareParticipant subject = new SubjectOfCareParticipantImpl( Arrays.asList( subjectIHI, medicareCard ), Arrays.asList( subjectOfCareAddress ), subjectOfCarePerson );
        ...
        OrderDetails order = new OrderDetailsImpl( PathologyId.orderID(hpioNumber), new SNOMEDCode( "26604007", "Complete blood count" ) );
        ...
        ReportDocument testResultDocument = new ReportDocumentImpl( title, testResult,doucmentID, SNOMED_CT_ResultStatusCode.PRELIMINARY, now);
        ...
        PathologyReportContent pathologyContent = new PathologyReportContentImpl( Arrays.asList( pathologyResult ), testResultDocument,reportingPathologist );
        ...
        PathologyReportCdaModel model = new PathologyReportCdaModel( document,  cdaCustodian,  healthCareID, now );
