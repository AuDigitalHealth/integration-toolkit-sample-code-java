...
public class DiagnosticImagingReportMaxTest extends Base {
    ...
    private static final String DOCUMENT_FILE_NAME = TEST_GENERATION + "diagnosticImage-device-max.xml";

    @Test
    public void test_MAX_DiagnosticImageReportCreation() throws ParserConfigurationException, JAXBException, SchemaValidationException, SchematronValidationException, IOException, ParseException,
            URISyntaxException {
        generateMax();
    ...
    public void generateMax() throws IOException, ParserConfigurationException, JAXBException, ParseException, SchematronValidationException {
        ...
        demoData.setDateOfDeath( new DateOfDeathImpl( deathDate, deathDateAccuracy, SourceOfDeathNotificationCode.HEALTH_CARE_PROVIDER ) );
        ...
        demoData.setBirthPlace( new CountryStateImpl( CountryEnum.AUSTRALIA.getDescriptor(), AustralianStateTerritory.NEW_SOUTH_WALES.getAbbreviation() ) );

        SubjectOfCarePerson subjectOfCarePerson = new ExtendedSubjectOfCarePerson( subjectPersonName, demoData );
        ...
        Entitlement subjectEntitlement = new EntitlementImpl( medicareCard, EntitlementType.MEDICARE_BENEFITS );
        ...
        Occupation authorOccupation = new OccupationImpl(   new ANZSCO_1ED_REV1( "599915", "Clinical Coder" ) );
        ProviderEmploymentDetail providerEmploymentDetail = new ProviderEmploymentDetailImpl( authorOccupation );
        ...
        ProviderAddress authorOrganisationAddress = new ProviderAddressImpl( false, fullAddress, AddressPurpose.BUSINESS );
        ...
        Telecom authorTelephone = new TelecomImpl( TelecomMedium.TELEPHONE, "0212345678", TelecomUse.BUSINESS );
        ...
        PathologyParticipantImpl authorParticipant = new PathologyParticipantImpl( authorHPII, authorPerson,pathologyLabEmployment, authorOrganisationAddress, electronicCommunicationDetailList );
        
        
       
        Entitlement entitlement = new EntitlementImpl( new MedicarePrescriberNumber("1234567A"), EntitlementType.MEDICARE_PRESCRIBER_NUMBER );
        ...
        Entitlement entitlement2 = new EntitlementImpl( new MedicarePrescriberNumber("1234567B"), EntitlementType.MEDICARE_PRESCRIBER_NUMBER );
        ...
        AsEntityIdentifier RequesterIdentifier = new AsEntityIdentifierImpl( "1.22.333.4444.55555", "12345678" );
        ...
        Entitlement requesterEntitlement = new EntitlementImpl( RequesterIdentifier, EntitlementType.MEDICARE_PRESCRIBER_NUMBER );
        ...
        List<Telecom> requesterComms = new ArrayList<Telecom>();
        ...
        ProviderAddress requesterAddress = new ProviderAddressImpl( false, requesterFullAddress, AddressPurpose.BUSINESS );
        
        
        Occupation requesterOccupation = new OccupationImpl( new ANZSCO_1ED_REV1( "253915", "Pathologist" ) );
        Role doctor = new RoleImpl( requesterOccupation );
        
        
        ProviderEmploymentDetail requesterEmploymentDetail = new ProviderEmploymentDetailImpl( requesterOccupation );
        ...
        RequesterParticipant requesterParticipant = new RequesterParticipantImpl( new HPII("8003610000001145"),organisationIds,clinic, requesterPerson );
        ...
        RequesterParticipation requester = new RequesterParticipationImpl( doctor, requesterParticipant, now );

        DiagnosticImageOrderDetails order = new DiagnosticImageOrderDetailsImpl( PathologyId.orderID(hpioNumber), PathologyId.diAccessionID(hpioNumber), new SNOMEDCode( "26604007", "Complete blood count" ) );

        DiagnosticImageReportContext imageContext = new DiagnosticImageReportContextImpl( subject, requester, author, order );
        ...
        DocumentParticipant reportingPathologist = new DocumentParticipantImpl( authorOccupation, authorParticipant );

        UniqueIdentifier doucmentID = new UniqueIdentifierImpl( UUID.randomUUID().toString());
        ...
        ReportDocument testResultDocument = new ReportDocumentImpl( title, testResult,doucmentID, code , now );
        ...
        List<AnatomicalSite> sites = new ArrayList<AnatomicalSite>();
        ...
        List<AnatomicalSite> sitesForResult3 = new ArrayList<AnatomicalSite>();
        sitesForResult3.add(new AnatomicalSiteImpl(new SNOMED_AU_Code( "123850002","Head part (body structure)" )) );
        ...
        DiagnosticImageReportContent diagnosticImageContent = new DiagnosticImageReportContentImpl( imageResults, testResultDocument,reportingPathologist/*, authorisationToPost*/);

        // Create Pathology Report
        DiagnosticImageResultReport diagnosticImageReport = new DiagnosticImageResultReportImpl( imageContext, diagnosticImageContent );
        ...
        AssignedEntity cdaLegalAuthenticatorAssignedEntity = AssignedEntityImpl.getInstance( documentID, legalAuthenticatorPerson, legalAuthenticatorOrganisation );
        ...
        cdaLegalAuthenticatorAssignedEntityCode.setCodeSystemName( "1220.0 - ANZSCO - Australian and New Zealand Standard Classification of Occupations, First Edition, Revision 1\"" );
        cdaLegalAuthenticatorAssignedEntityCode.setDisplayName( "General Medical Practitioner" );

        // ...or use a pre-baked version
        cdaLegalAuthenticatorAssignedEntity.setCode( new ANZSCO_1ED_REV1( "253111", "General Medical Practitioner") );
        ...
        DiagnosticImagingReportCdaModel model = new DiagnosticImagingReportCdaModel( document, cdaLegalAuthenticator, cdaCustodian,   now );
        DiagnosticImageReportCreator diCreator = new DiagnosticImageReportCreator( model, diagnosticImageReport );
