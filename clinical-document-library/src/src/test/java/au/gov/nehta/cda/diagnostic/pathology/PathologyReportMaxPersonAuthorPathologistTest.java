...
public class PathologyReportMaxPersonAuthorPathologistTest extends Base {
    ...
    @Test
    public void test_MAX_PathologyReportCreation() throws ParserConfigurationException, JAXBException, SchemaValidationException, SchematronValidationException, IOException, ParseException,
            URISyntaxException {
        generateMax();
