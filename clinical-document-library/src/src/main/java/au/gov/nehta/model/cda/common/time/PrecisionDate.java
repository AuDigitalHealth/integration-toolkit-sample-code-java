 ...
 * PrecisionDate
 * 
 * A JodaTime DateTime that also holds and Precision type indicating 
...
public class PrecisionDate implements PreciseDate {
	...
	/**
	 * Create a Date with a Prescision <br/>
	...
	/**
	 * convenience method to return the current date 
	 * with DAY precision
	 */
	 ...
	 *  
	 * @param	timePrecision	the amount of time to use. eg: Precision.day indicating 
	 * 							that hours, minutes and seconds are to be ignored
	 * @param   timeInMilliseconds   the milliseconds since January 1, 1970, 00:00:00 GMT.
     * @see     java.lang.System#currentTimeMillis()
	 */
	...
	/**
	 ** Constructed a date with the specified precision
	 *  equivalent to this(timePrecision, date.getTime())
	 *  
	 * @param	timePrecision	the amount of time to use. eg: Precision.day indicating 
	 * 							that hours, minutes and seconds are to be ignored
	 * @param   timeInMilliseconds   the milliseconds since January 1, 1970, 00:00:00 GMT.
	 ...
	 * 
	 * for example, a PrecisionDate with a Precsion.Day accuracy will print yyyyMMdd
	 * while a  PrecisionDate with a Precsion.Millisecond with a millisecond accuracy will print
	 * yyyyMMddHHmmss.SSSZ
	 * 
	 */
	@Override
