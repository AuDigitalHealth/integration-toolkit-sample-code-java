...
public class ImmunisationImpl implements Immunisation {
	 ...
	 * 
	 *            Australian Medicines Terminology <br>
	 *            The permissible values are the members of <br>
	 *            the following AMT reference sets:<br>
	 *            • 929360061000036106 Medicinal product reference set<br>
	 *            • 929360081000036101 Medicinal product pack reference set<br>
	 *            • 929360021000036102 Trade product reference set<br>
	 ...
	 *            optional - The sequence number specific to the action being
	 *            recorded
	 */
