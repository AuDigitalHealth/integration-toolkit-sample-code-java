...
public enum GroundsForConcurrentSupply implements EnumTuple {
	PURSUANT_TO_REGULATION_24( "1", "Supply is in accord with Regulation 24 of the National Health (Pharmaceutical Benefits) Regulations 1960." ), HARDSHIP_CONDITIONS_APPLY( "2",
			"Supply is in accord with the “Hardship conditions” provision of RPBS prescribing guidelines." ), NO_GROUNDS( "3", "There are no grounds for concurrent supply." );
