...
public class DiagnosticImageOrderDetailsImpl extends UniqueIdentifierImpl implements DiagnosticImageOrderDetails {
    
    private UniqueIdentifier accessionNumber;
    private Coded order;
    private UniqueIdentifier id;
    
    public DiagnosticImageOrderDetailsImpl( UniqueIdentifier id,UniqueIdentifier accessionNumber, Coded order ) {
	...
	public void setAccessionNumber(UniqueIdentifier accessionNumber) {
