...
public class RelatedDocumentImpl implements RelatedDocument {
     ...
     *      If @typeCode=”XFRM”; theid/@root SHALL contain an im-plementation specific OID andid/@extension SHALL containthe 'Source Record Identifier' ofthe original/parent document.
     *      If @typeCode=”RPLC”; the par-ent/id SHALL contain the Clinic-alDocument/id of the documentbeing replaced.
     *      
     * @param typeCode      HL7 v3 CDA: RelatedDocument.typeCode
     *      A conformant CDA documentMAY have a single relatedDocument with typeCode "XFRM"; acombination of two relatedDocuments with typeCodes "XFRM"and "RPLC". No other combinations SHALL be allowed.
     * 
     */
    ...
    /**
     * SetId
     * Represents an identifier that is common across all document revi-sions.
     * If @typeCode=”RPLC”; the setIdSHALL match the setId of thecurrent document.
     * 
     * @param setId
     */
