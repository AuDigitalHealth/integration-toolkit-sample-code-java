...
public enum AddressPurpose implements EnumTuple {
	...
	BUSINESS( "1", "Business", "B" ), MAILING_OR_POSTAL( "2", "Mailing or Postal", "M" ), TEMPORARY_ACCOMMODATION( "3", "Temporary Accommodation", "T" ), RESIDENTIAL_PERMANENT( "4",
			"Residential (permanent)", "R" ), NOT_STATED_OR_UNKNOWN_OR_INADEQUATELY_DESCRIBED( "9", "Not Stated/Unknown/Inadequately Described", "U" );

	private final String CODE_SYSTEM = "1.2.36.1.2001.1001.101.103.10264";
	private final String CODE_SYSTEM_NAME = "AS 5017 (2006) - Healthcare Client Identification; AS 4846 (2006) - Healthcare Provider Identification";
