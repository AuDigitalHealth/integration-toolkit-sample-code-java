...
public class AddressConverter {
    ...
    public static void getCountryState( CountryState cs, AD address ) {
    ...
    public static List<AD> convert( List<? extends AddressContext> ctx ) {
    	...
    	List<AD> addressElements = new ArrayList<AD>(ctx.size());
    ...
    public static AD convert( AddressContext ctx ) {
        ...
        if (ctx.getNoFixedAddressIndicator() || ctx.getAddress() == null) {
            address.setNullFlavor( NullFlavor.NA );
        } else {
    ...
    private static void addDPID( AD address, String dpid ) {
        if ( isNotEmpty( dpid ) )  {
            ...
            JAXBElement<AdxpAdditionalLocator> additionalLocator = new ObjectFactory().createADAdditionalLocator( adxpAdditionalLocator );
    ...
    private static void addPostcode( AD address, String modelPostalCode ) {
        if( isNotEmpty( modelPostalCode )){
            ...
            JAXBElement<AdxpPostalCode> postalCode = new ObjectFactory().createADPostalCode( adxpPostalCode );
    ...
    private static void addAddressLines( AD address, List<String> addressLines ) {
        if(addressLines != null){
            for (String cdaModelPostalAddressStreetAddressLine : addressLines) {
                ...
                JAXBElement<AdxpStreetAddressLine> streetAddressLine = new ObjectFactory().createADStreetAddressLine( adxpStreetAddressLine );
    ...
    public static PostalAddressUse getPostalAddressUse( AddressPurpose purpose ) {
