...
public class ClinicalModelConverter {
	...
	public static POCDMT000040Organization getPrescriberOrganization( PrescriberOrganisationParticipant prescriberOrganisationParticipant ) {
		return getProviderOrganization( prescriberOrganisationParticipant.getOrganisation(), prescriberOrganisationParticipant.getEntityIdentifiers(), prescriberOrganisationParticipant.getAddresses(),
				prescriberOrganisationParticipant.getElectronicCommunicationDetail() );
	}

	public static POCDMT000040Organization getDispensingOrganization( DispensingOrganisationParticipant dispensingOrganisationParticipant ) {
	...
	public static POCDMT000040Organization getProviderOrganization( Organisation organisation, HPIO hpio, ProviderAddress providerAddress,
	...
	public static POCDMT000040Person getPrescriberPerson( DefaultParticipant prescriberParticipant ) {
		POCDMT000040Person person = getPerson( prescriberParticipant.getPerson().getPersonName(), prescriberParticipant.getEntityIdentifiers(),  prescriberParticipant.getQualifications() );
		person.setAsEmployment( getEmployment( prescriberParticipant.getPerson().getEmploymentDetail() ) );
		return person;
	}
	
	public static POCDMT000040Person getRequestersPerson( RequesterParticipant requesterParticipant ) {
        POCDMT000040Person person = getPerson( requesterParticipant.getPerson().getPersonName(), requesterParticipant.getEntityIdentifiers(),  requesterParticipant.getQualifications() );
        person.setAsEmployment( getEmployment( requesterParticipant.getPerson().getEmploymentDetail() ) );
        
        POCDMT000040Organization providerOrganization = getProviderOrganization(requesterParticipant.getOrganisation(), null , null, null);
     
        POCDMT000040Organization wholeOrganization = providerOrganization.getAsOrganizationPartOf().getWholeOrganization();
	...
	public static POCDMT000040Person getRefereePerson( ReferralParticipant referee ) {
        POCDMT000040Person person = getPerson( referee.getParticipantName(), referee.getParticipantHPII() , null);
	...
	public static POCDMT000040Person getAuthorPerson( AuthorParticipant authorParticipant ) {
        POCDMT000040Person person = getPerson( authorParticipant.getPerson().getPersonName(), authorParticipant.getEntityIdentifiers(),authorParticipant.getQualifications());
        
        person.setAsEmployment( getEmploymentOrganisation(authorParticipant.getEmploymentOrganisation()) );
        
        return person;
    }
	
	public static Employment getEmploymentOrganisation( EmploymentOrganisation employmentOrg ) {
	    if(employmentOrg == null) return null;
        ...
        List<? extends AsEntityIdentifier> organisationIdentifiers = employmentOrg.getOrganisationIdentifiers();
	...
	public static Employment getExtendedEmploymentOrganisation( ExtendedEmploymentOrganisation employmentOrg ) {
	    if(employmentOrg == null) return null;
	    
	    //map the base employment
	    Employment employment = getEmploymentOrganisation( employmentOrg );
	    
	    POCDMT000040Organization wholeOrganization = employment.getEmployerOrganization().getAsOrganizationPartOf().getWholeOrganization();
	    ...
	    if(employmentOrg.getElectronicCommunicationDetails() != null && !employmentOrg.getElectronicCommunicationDetails().isEmpty()){
	    	wholeOrganization.getTelecom().addAll(  Converter.convert(employmentOrg.getElectronicCommunicationDetails()));
	    }
	    
        return employment;
    }

	public static Employment getEmployment( ProviderEmploymentDetail prescriberEmploymentDetail ) {
		Employment employment = new Employment();
		employment.setClassCode( EntityClass.EMP );
	...
	public static POCDMT000040Person getPerson( PersonName personName, HPII providerEntityIdentifier, String providerQualifications ) {
		POCDMT000040Person person = new POCDMT000040Person();
		
		person.getAsEntityIdentifier().addAll( Arrays.asList( Converter.convert( providerEntityIdentifier ) ) );
	...
	public static List<Coverage2> getSubjectOfCareEntitlements( SubjectOfCareParticipant soc ) {
		...
		List<Coverage2> coverage2 = new ArrayList<Coverage2>();
	...
	private static void addSOCEntitlements(List<? extends Entitlement> ents, String patientRoleId, List<Coverage2> coverage2) {
		for (Entitlement subjectOfCareEntitlement : ents) {
			...
			coverage2itemEntitlement.setId( Converter.getII( subjectOfCareEntitlement.getEntitlementNumber()  ) );
			coverage2itemEntitlement.setCode( EntitlementTypeCodeSet.convert( subjectOfCareEntitlement.getEntitlementType() ) );
			...
			coverage2itemEntitlementParticipant.setParticipantRole( coverage2itemEntitlementParticipantParticipantRole );
			coverage2itemEntitlement.getParticipant().add( coverage2itemEntitlementParticipant );
			coverage2itemEntitlement.setEffectiveTime( Converter.convert( subjectOfCareEntitlement.getEntitlementValidityDuration() ) );
	...
	public static List<Coverage2> getParticpantEntitlements( List<? extends Entitlement> entitlements, String assignedAuthorId ) {
		List<Coverage2> coverage2 = new ArrayList<Coverage2>();
	...
	public static Coverage2 getParticipantEntitlement( Entitlement entitlement, String assignedAuthorId ) {
		Coverage2 coverage2item = new Coverage2();
		coverage2item.setTypeCode( COVERAGE2_TYPE_CODE );
		au.net.electronichealth.ns.ci.cda.extensions._3.Entitlement coverage2itemEntitlement = new au.net.electronichealth.ns.ci.cda.extensions._3.Entitlement();
		coverage2itemEntitlement.setClassCode( EntityClass.COV );
		...
		coverage2itemEntitlement.setCode( EntitlementTypeCodeSet.convert( entitlement.getEntitlementType() ) );
		au.net.electronichealth.ns.ci.cda.extensions._3.Participant coverage2itemEntitlementParticipant = new au.net.electronichealth.ns.ci.cda.extensions._3.Participant();
		...
		if(entitlement.getEntitlementValidityDuration()  != null){
			coverage2itemEntitlement.setEffectiveTime( Converter.convert( entitlement.getEntitlementValidityDuration() ) );
		}
		coverage2item.setEntitlement( coverage2itemEntitlement );
	...
	public static List<Coverage2> getDispensingOrganisationEntitlements( List<? extends Entitlement> entitlements, String participantRoleId ) {
		List<Coverage2> coverage2 = new ArrayList<Coverage2>();

		for (Entitlement entitlement : entitlements) {
			Coverage2 coverage2item = getDispensingOrganisationEntitlement( entitlement, participantRoleId );
			coverage2.add( coverage2item );
		}
	...
	public static Coverage2 getDispensingOrganisationEntitlement( Entitlement entitlement, String participantRoleId ) {
		Coverage2 coverage2item = new Coverage2();
		coverage2item.setTypeCode( COVERAGE2_TYPE_CODE );
		au.net.electronichealth.ns.ci.cda.extensions._3.Entitlement coverage2itemEntitlement = new au.net.electronichealth.ns.ci.cda.extensions._3.Entitlement();
		coverage2itemEntitlement.setClassCode( EntityClass.COV );
