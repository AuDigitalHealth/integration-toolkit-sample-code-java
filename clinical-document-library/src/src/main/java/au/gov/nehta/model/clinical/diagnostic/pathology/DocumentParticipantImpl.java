...
public class DocumentParticipantImpl implements DocumentParticipant {
	...
	public DocumentParticipantImpl(Role role,  AuthorParticipant participant ) {
		...
		if(participant.getEmploymentOrganisation()==null || participant.getEmploymentOrganisation().getOrganisationIdentifiers() == null){
		    throw new IllegalArgumentException("AuthorParticipant must have employmentOrganisation and OrganisationIdentifiers");
		}
