...
public class ProblemDiagnosisImpl implements ProblemDiagnosis {
	 ...
	 *            Identification of the problem or diagnosis. a snomed ct-au
	 *            code
	 * @param dateOfOnset
	 *            optional Estimated or actual date the Problem/Diagnosis began,
	 ...
	 *            optional
	 * 
	 *            The date or estimated date that the problem/diagnosis resolved
	 *            or went into remission, as indicated/identified by the
	 *            clinician.
	 */
	public ProblemDiagnosisImpl(SNOMED_AU_Code identification, PreciseDate dateOfOnset, PreciseDate remissionDate, String comment) {
	 ...
	 * optional
	 * 
	 * The date or estimated date that the problem/diagnosis resolved or went
