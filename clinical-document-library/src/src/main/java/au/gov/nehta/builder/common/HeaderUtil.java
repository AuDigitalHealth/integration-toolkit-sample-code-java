...
public class HeaderUtil {
	...
	public static POCDMT000040ClinicalDocument createClinicalDocument( BaseClinicalDocument model  ) {
		...
		clinicalDocument.setEffectiveTime( getTimeNow() );
	...
	public static CE getConfidentialityCode() {
		...
		((CD) confidentialityCode).setNullFlavor( NullFlavor.NA );

		return confidentialityCode;
	}

	public static POCDMT000040InfrastructureRootTypeId getClinicalDocumentTypeId( TypeId cdaModelTypeId ) {
	...
	public static II getClinicalDocumentTemplateId( TemplateId cdaModelTemplateId ) {
	...
	public static TS getTimeNow() {
		return Converter.getTS( new DateTime() );
	}

	public static CS getLanguageCode( String cdaModelLanguageCode ) {
	...
	// Legal Authenticator
	public static POCDMT000040LegalAuthenticator createLegalAuthenticator( LegalAuthenticator cdaModelLegalAuthenticator ) {
		...
		legalAuthenticator.setAssignedEntity( CDAModelConverter.convertAssignedEntity( cdaModelLegalAuthenticator.getAssignedEntity() ) );

		return legalAuthenticator;
	}
	
   public static Collection<? extends POCDMT000040RelatedDocument> createRelatedDocuments( List<RelatedDocument> relatedDocuments ) {
       List<POCDMT000040RelatedDocument> mappedDocuments = new ArrayList<POCDMT000040RelatedDocument>(relatedDocuments.size());
...
//        parent.se
        if(d.getVersionNumber() != null ){
            INT int1 = new INT();
            int1.setValue( BigInteger.valueOf(d.getVersionNumber().intValue()) );
    ...
    public static POCDMT000040Author createAuthorWithTime( String assignedAuthorId, Role authorRole, ProviderAddress authorAddress, List<Telecom> authorElectronicCommunicationDetail,
            POCDMT000040Person assignedAuthorPerson, DateTime authorTime ) {
        return createAuthorWithTime(assignedAuthorId,authorRole.getCode(),authorAddress,authorElectronicCommunicationDetail,assignedAuthorPerson,authorTime);
    }
    
    public static POCDMT000040Author createAuthorWithTime( String assignedAuthorId, Coded authorRole, ProviderAddress authorAddress, List<Telecom> authorElectronicCommunicationDetail,
            POCDMT000040Person assignedAuthorPerson, DateTime authorTime ) {
        POCDMT000040Author author = getBaseAuthor( assignedAuthorId, authorRole, authorAddress, authorElectronicCommunicationDetail, assignedAuthorPerson );
    ...
    public static POCDMT000040Author createAuthorWithCurrentTime( String assignedAuthorId, Role authorRole, ProviderAddress authorAddress, List<Telecom> authorElectronicCommunicationDetail,
	        POCDMT000040Person assignedAuthorPerson ) {
		POCDMT000040Author author = getBaseAuthor( assignedAuthorId, authorRole.getCode(), authorAddress, authorElectronicCommunicationDetail, assignedAuthorPerson );
		  TS creationTime = new TS();
	...
	public static POCDMT000040Author createAuthorNullFlavourTime( String assignedAuthorId, Role authorRole, ProviderAddress authorAddress, List<Telecom> authorElectronicCommunicationDetail,
            POCDMT000040Person assignedAuthorPerson ) {
        POCDMT000040Author author = getBaseAuthor( assignedAuthorId, authorRole.getCode(), authorAddress, authorElectronicCommunicationDetail, assignedAuthorPerson );
        TS creationTime = new TS();
    ...
    public static POCDMT000040Author getBaseAuthor( String assignedAuthorId, Coded authorRole, ProviderAddress authorAddress, List<Telecom> authorElectronicCommunicationDetail,
            POCDMT000040Person assignedAuthorPerson ) {
    ...
    public static void mapPersonExtensions( POCDMT000040Patient patient, ExtendedSubjectOfCarePerson person ) {
    ...
    public static void mapSOCPerson( POCDMT000040Patient patient, SubjectOfCarePerson person ) {
        ...
        patient.setBirthTime( Converter.getTS( person.getDemographicData().getDateOfBirthDetail().getDateOfBirth() ) );
        final BL multipleBirthInd = getMultipleBirthInd( person.getDemographicData().getBirthPlurality() );
        patient.setMultipleBirthInd( multipleBirthInd );
        if (multipleBirthInd.isValue()) {
            patient.setMultipleBirthOrderNumber( Converter.convertIntegerToINT( person.getDemographicData().getBirthOrder() ) );
        }
	...
	public static BL getMultipleBirthInd( Integer birthPlurality ) {
	...
	// Location
	public static POCDMT000040Location createLocation( Role clinicalModelParticipationRole, POCDMT000040Organization serviceProviderOrganizationPartOf, String healthCareFacilityId ) {
	...
	public static CE getHealthCareFacilityCode( Role clinicalModelRole ) {
		return Converter.convertToCECode( clinicalModelRole.getCode() );
	}

	// Custodian
	public static POCDMT000040Custodian createCustodian( CustodianOrganization cdaModelAssignedCustodianRepresentedOrganization ) {
		POCDMT000040Custodian custodian = new POCDMT000040Custodian();
		custodian.setAssignedCustodian( CDAModelConverter.convertAssignedCustodian( cdaModelAssignedCustodianRepresentedOrganization ) );

		return custodian;
	}
	
    public static POCDMT000040Birthplace getBirthPlace( CountryState countryState ) {
	...
	public static POCDMT000040Component1 createEncompassingEncounter( Role clinicalModelParticipationRole, POCDMT000040Organization serviceProviderOrganizationPartOf, String healthCareFacilityId ) {
		...
		POCDMT000040Location location = HeaderUtil.createLocation( clinicalModelParticipationRole, serviceProviderOrganizationPartOf, healthCareFacilityId );
    ...
    public static POCDMT000040Participant1 createParticipant( RequesterParticipation requester ) {
        ...
        POCDMT000040Person person2 = ClinicalModelConverter.getRequestersPerson(requester.getParticipant() );
