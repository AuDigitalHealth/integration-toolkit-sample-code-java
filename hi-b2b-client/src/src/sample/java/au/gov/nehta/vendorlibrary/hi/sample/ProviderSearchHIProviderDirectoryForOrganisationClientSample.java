...
import au.gov.nehta.vendorlibrary.hi.hpio.ProviderSearchHIProviderDirectoryForOrganisationClient;
 ...
 */
public final class ProviderSearchHIProviderDirectoryForOrganisationClientSample {
//Example values for Client product information (PCIN).
   ...
   */
  private ProviderSearchHIProviderDirectoryForOrganisationClientSample() {
  ...
  public static void main(String[] args) throws GeneralSecurityException, IOException {
    ...
    try {
      SearchHIProviderDirectoryForOrganisationResponse searchHIProviderDirectoryForOrganisationResponse =
