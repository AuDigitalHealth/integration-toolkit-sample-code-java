...
import au.gov.nehta.vendorlibrary.hi.readreferencedata.ReadReferenceDataClient;
 ...
 * <p/>
 * g) Parameters for Read Reference Data Lookup                  <br/><br/>
...
//Example values for Client product information (PCIN).
  ...
  /**
   * Reader Reference Data Provider code.<br/> Example provided here.
   */
  private static final String PROVIDER_TYPECODE = "providerTypeCode";

  /**
   * Default private constructor.
   */
  private ReadReferenceDataClientSample() {
  ...
  public static void main(String[] args) throws GeneralSecurityException, IOException {
    ...
    ReadReferenceDataClient testClient = new ReadReferenceDataClient(MEDICARE_ENDPOINT_URL,
      userQualifiedId,
      productHeader,
    ...
    readReferenceData.getElementNames().add(PROVIDER_TYPECODE);
