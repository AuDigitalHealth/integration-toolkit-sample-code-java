...
//Example values for Client product information (PCIN).
   ...
   */
  private ConsumerSearchIHIClientSample() {

  }

  /**
   * Main method to invoke IHI basic search.
   *
   * @param args user arguments for main method invocation (NOT REQUIRED)
   * @throws GeneralSecurityException in an event of security / certificate error.
   * @throws IOException              in an event of IO exception.
   */
  public static void main(String[] args) throws GeneralSecurityException, IOException {
    ...
    ConsumerSearchIHIClient testClient = new ConsumerSearchIHIClient(MEDICARE_ENDPOINT_URL,
      userQualifiedId,
      productHeader,
    ...
    SearchIHI searchIHI = getSearchIHI();
  ...
  /**
   * Returns the IHI basic search criteria as SearchIHI
   *
   * @return IHI search IHI instance.
   */
  private static SearchIHI getSearchIHI() {
