...
import au.gov.nehta.vendorlibrary.hi.hpio.ProviderManageProviderOrganisationClient;
 ...
 * <br/>
 */
public final class ProviderManageProviderOrganisationClientSample {
	 ...
	 */
	private ProviderManageProviderOrganisationClientSample() {
	...
	public static void main(String[] args) throws GeneralSecurityException, IOException {
		 ...
		 * Manage Provider Organisation Details TECH.SIS.HI.14
		 */
		
		ProviderManageProviderOrganisationClient testClient = new ProviderManageProviderOrganisationClient(MEDICARE_ENDPOINT_URL, userQualifiedId, productHeader, clientSigningPrivateKey,
		...
		//A – Active D – Deactivate. R – Retired.
		status.setStatus("R");
		status.setReason("Close of Business");
		...
		try {
			ManageProviderOrganisationResponse searchHIProviderDirectoryForOrganisationResponse = testClient.manageProviderOrganisation(request);
