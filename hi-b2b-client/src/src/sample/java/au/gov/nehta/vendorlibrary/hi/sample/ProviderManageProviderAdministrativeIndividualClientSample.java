...
import au.gov.nehta.vendorlibrary.hi.hpio.ProviderManageProviderAdministrativeIndividualClient;
 ...
 * <br/>
 */
public final class ProviderManageProviderAdministrativeIndividualClientSample {
	 ...
	 */
	private ProviderManageProviderAdministrativeIndividualClientSample() {
	...
	public static void main(String[] args) throws GeneralSecurityException, IOException {
		 ...
		 * Manage Provider or Administrative Individual Details TECH.SIS.HI.13
		 */
		
		ProviderManageProviderAdministrativeIndividualClient testClient = new ProviderManageProviderAdministrativeIndividualClient(MEDICARE_ENDPOINT_URL, userQualifiedId, productHeader, clientSigningPrivateKey,
		...
		try {
			ManageProviderAdministrativeIndividualResponse searchHIProviderDirectoryForOrganisationResponse = testClient.manageProviderAdministrativeIndividual(request);
