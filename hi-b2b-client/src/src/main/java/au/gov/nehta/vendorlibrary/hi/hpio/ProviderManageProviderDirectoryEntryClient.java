...
import au.net.electronichealth.ns.hi.svc.providermanageproviderdirectoryentry._3_2.ProviderManageProviderDirectoryEntryService;
...
public class ProviderManageProviderDirectoryEntryClient extends BaseClient_3<ProviderManageProviderDirectoryEntryPortType> {
     ...
     * 
     * @param request
     *            the ManageProviderDirectoryEntry request object
     ...
     *             if the Web Service call fails.
      */
    public final ManageProviderDirectoryEntryResponse manageProviderDirectoryEntry( ManageProviderDirectoryEntry  request ) throws StandardErrorMsg   {
