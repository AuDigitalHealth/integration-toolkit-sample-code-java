 ...
 */
public class AttachmentVerificationException extends Exception {
   ...
   */
  public AttachmentVerificationException(final String message) {
    super(message);
  }
  ...
  public AttachmentVerificationException(final String message, final Exception e) {
    super(message, e);
  }
}
