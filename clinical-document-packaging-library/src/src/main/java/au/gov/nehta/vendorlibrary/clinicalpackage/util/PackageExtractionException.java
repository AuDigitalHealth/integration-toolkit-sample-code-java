 ...
 */
public class PackageExtractionException extends Exception {
   ...
   */
  public PackageExtractionException(final String message) {
    super(message);
  }
  ...
  public PackageExtractionException(final String message, final Exception e) {
    super(message, e);
  }
}
