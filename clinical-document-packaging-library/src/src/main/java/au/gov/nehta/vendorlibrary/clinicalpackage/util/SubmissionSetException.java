...
/**
 * Thrown to indicate that a {@link au.gov.nehta.vendorlibrary.clinicalpackage.core.SubmissionSet}
 * has been passed an illegal or inappropriate argument.
 */
public final class SubmissionSetException extends RuntimeException {
  ...
  /**
   * Constructs a <code>SubmissionSetException</code> with the supplied errors.
   *
