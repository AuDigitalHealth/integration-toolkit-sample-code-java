...
_________________________________________________________________________________________________________________________________________________________________________________________
                  ...
                  Generated          : 26/06/2013 4:22:17 PM
...
<schema xmlns="http://www.ascc.net/xml/schematron">
    ...
    <pattern name="p-e-Prescription_3A_Prescriptionitem_8_2_custom-errors"
        ...
        <rule context="/cda:ClinicalDocument/cda:component/cda:structuredBody/cda:component/cda:section[cda:code/@code='102.16211']/cda:entry/cda:substanceAdministration[@classCode='SBADM']/cda:doseQuantity">
            ...
            <assert test="not(@unit and parent::cda:substanceAdministration/cda:consumable/cda:manufacturedProduct/cda:manufacturedMaterial/ext:formCode)"
                >Error: e-Prescription - 8.2 Prescription item -
                "Prescription Item / Structured Dose / Dose Unit" -
                The 'substanceAdministration' tag shall have 'doseQuantity' tag 'unit' attribute or shall have 'cda:substanceAdministration/cda:consumable/cda:manufacturedProduct/cda:manufacturedMaterial/ext:formCode' tag
                Refer to section 8.2 of the
                e-Prescription_CDA_Implementation_Guide_v0.3.</assert>  
        </rule>
        ...
        <rule context="/cda:ClinicalDocument/cda:component/cda:structuredBody/cda:component/cda:section[cda:code/@code='102.16211']/cda:entry/cda:substanceAdministration[@classCode='SBADM']/cda:entryRelationship/cda:supply[@classCode = 'SPLY']/cda:quantity">
            ...
            <assert test="@value 
                and 
                (@unit or parent::cda:supply/cda:product/cda:manufacturedProduct/cda:manufacturedMaterial/ext:formCode)"
                >Error: e-Prescription - 8.2 Prescription item -
                "Prescription Item / QUANTITY TO DISPENSE / Quantity" -
                The 'quantity' tag 'value' attribute SHALL be co-existed with 'quantity' tag 'unit' attribute or '/cda:ClinicalDocument/cda:component/cda:structuredBody/cda:component/cda:section[cda:code/@code = '102.16211']/cda:entry/cda:substanceAdministration[@classCode = 'SBADM']/cda:entryRelationship/cda:supply[@classCode = 'SPLY']/cda:product/cda:manufacturedProduct/cda:manufacturedMaterial/ext:formCode'.
                Refer to section 8.2 of the
                e-Prescription_CDA_Implementation_Guide_v0.3.</assert> 
            
            <!-- Prescription Item > QUANTITY TO DISPENSE > Dispensing Unit | IG Page 128-->
            <assert test="not(@unit and parent::cda:supply/cda:product/cda:manufacturedProduct/cda:manufacturedMaterial/ext:formCode)"
                >Error: e-Prescription - 8.2 Prescription item -
                "Prescription Item / QUANTITY TO DISPENSE / Dispensing Unit" -
                The 'supply' tag shall have 'quantity' tag 'unit' attribute or shall have 'cda:product/cda:manufacturedProduct/cda:manufacturedMaterial/ext:formCode' tag
                Refer to section 8.2 of the
                e-Prescription_CDA_Implementation_Guide_v0.3.</assert>  
        </rule>
