...
<schema xmlns="http://www.ascc.net/xml/schematron">
    ...
    <pattern name="p-e-Prescription_2_Global_Code_Checks-errors"
        id="p-e-Prescription_2_Global_Code_Checks-errors"
        see="#p-e-Prescription_2_Global_Code_Checks-errors">
