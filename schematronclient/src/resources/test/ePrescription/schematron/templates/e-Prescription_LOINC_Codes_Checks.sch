...
<schema xmlns="http://www.ascc.net/xml/schematron">
    ...
    <pattern name="p-e-Prescription_LOINC_Codes_Checks-errors"
        id="p-e-Prescription_LOINC_Codes_Checks-errors"
        see="#p-e-Prescription_LOINC_Codes_Checks-errors">
...
-->
        ...
        <rule context="*[(@codeSystem='2.16.840.1.113883.6.1')]">
            ...
            <report test="(@codeSystemName) and (@codeSystemName != 'LOINC')">Error: e-Prescription
                - Global Clinical Document check for LOINC
                ...
                e-Prescription_CDA_Implementation_Guide_v0.3 and
                LOINC_Concepts_Identifier_Requirements.</report>


            <assert test="string-length(@code) &gt;= 3">>Error: e-Prescription - Global Clinical
                Document check for LOINC "*[(@codeSystem='2.16.840.1.113883.6.1')]/@code" attribute
                - The 'code' attribute value length shall be minimum 3 characters. Check all such
            ...
            <assert test="string-length(@code) &lt;= 10">Error: e-Prescription - Global Clinical
                Document check for LOINC "*[(@codeSystem='2.16.840.1.113883.6.1')]/@code" attribute
                - The 'code' attribute value length shall be maximum 10 characters. Check all such
                'code' attributes to find the incorrect attribute(s). Refer to section 8.1 of the
                e-Prescription_CDA_Implementation_Guide_v0.3 and
                LOINC_Concepts_Identifier_Requirements.</assert>


            <assert test="(substring(@code, (string-length(@code)-1), 1) = '-')">Error:
                e-Prescription - Global Clinical Document check for LOINC
            ...
            <assert
                ...
                >Error: e-Prescription - Global Clinical Document check for LOINC
                "*[(@codeSystem='2.16.840.1.113883.6.1')]/@code" attribute - The 'code' attribute
            ...
            <assert test="not(contains(@code, '.'))">Error: e-Prescription - Global Clinical
                Document check for LOINC "*[(@codeSystem='2.16.840.1.113883.6.1')]/@code" attribute
            ...
            <assert
                ...
                section 8.1 of the e-Prescription_CDA_Implementation_Guide_v0.3 and
                LOINC_Concepts_Identifier_Requirements.</assert>
