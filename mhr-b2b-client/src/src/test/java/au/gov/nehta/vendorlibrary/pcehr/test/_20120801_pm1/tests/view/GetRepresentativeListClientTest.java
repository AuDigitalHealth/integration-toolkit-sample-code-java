...
public class GetRepresentativeListClientTest {
  ...
  public final void setUp() throws Exception {
    ...
    client = new GetRepresentativeListClient(
      ...
      Endpoints.PM1_GET_REPRESENTATIVE_LIST,
  ...
  public void test_010() throws Exception {
    ...
    Assert.assertEquals("PCEHR_ERROR_6001", response.getResponseStatus().getCode());
    Assert.assertEquals("No representatives found", response.getResponseStatus().getDescription());
  }
}
