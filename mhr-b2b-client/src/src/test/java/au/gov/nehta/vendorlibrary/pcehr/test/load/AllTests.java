...
package au.gov.nehta.vendorlibrary.pcehr.test.load;
...
public class AllTests {
  ...
  public static void setUp() throws Exception {
    ...
    defaultRequest = MessageComponents.createRequest(
      ...
      MessageComponents.createAccessingOrganisation("8003627500001433", "2", null)
    );

    sslSocketFactory = SecurityUtil.getSslSocketFactory(SecurityConstants.ALIAS_8003627500001433);

    certificate = SecurityUtil.getCertificate(SecurityConstants.ALIAS_8003627500001433);
    ...
    privateKey = SecurityUtil.getPrivateKey(
      ...
      SecurityConstants.ALIAS_8003627500001433
    );
