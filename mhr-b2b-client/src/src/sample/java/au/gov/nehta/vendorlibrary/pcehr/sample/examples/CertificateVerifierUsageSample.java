 ...
 * under the License.
 */
package au.gov.nehta.vendorlibrary.pcehr.sample.examples;
...
/**
 * Basic sample class showing how to use a certificate verifier with the existing PCEHR clients.
 * <p/>
 * Note that this example uses the MinimalCertificateVerifier implementation. For production code, a vendor-specific
 * implementation should be utilised. For the most part, this example mirrors the existing client samples.
 */
public class CertificateVerifierUsageSample {

  private CertificateVerifierUsageSample() {
  }
  ...
  public static void main(String[] args) throws IOException, GeneralSecurityException, StandardErrorMsg {
    ...
    client = new DoesPCEHRExistClient(
      ...
      new MinimalCertificateVerifier(),  // Note: this is where an instance of the certificate verifier is supplied.
